...
r.set("data",i),r.save(null,{success:function(e){t(e.id)},error:function(t,e){console.log("Failed to create new object, with error code: "+e.message)}}),debug&&console.log(i)}function exportCanvas(){var t=document.getElementById(element_id.header)
t.style.visibility="hidden"
var e=document.getElementById(element_id.canvas),n=new createjs.Bitmap(e)
n.cache(0,0,e.width,e.height,1)
var i=n.getCacheDataURL()
print(i),t.style.visibility="visible"}function share(){var t=document.getElementById("share_button")
t.setAttribute("disabled","disabled"),centerKnoll(function(){knollChanged||null==last_id?save(showShare):showShare(last_id)})}function showShare(t){last_id=t,knollChanged=!1,hide(element_id.header),show(element_id.share)
var e=document.getElementById(element_id.share)
input=e.getElementsByTagName("INPUT")[0],input.value="http://stupiddesk.com/?"+t,input.select()}function tweet(){var t=document.getElementById(element_id.share)
